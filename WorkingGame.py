...
#   Intro Scene
#   FloorPlan 
#   Room1       Living Room     (Red -> Basement,       Green -> Dining room,   Blue-> itself) red goes to room5
#   Room2       Dining Room     (Red -> Living Room,    Green -> itself,        Blue-> Bedroom)
#   Room3       Bedroom         (Red-> Attic,           Green -> Dining Room,   Blue-> itself)
#   Room4       attic           (Red -> Basement,       Green -> BedRoom,       Blue-> itself)
#   Room5       basement        (Red -> bedroom2,       Green -> itself,        Blue-> hallway) red goes to room7
#   Room6       hallway         (Red-> itself,          Green -> bedroom2,      Blue-> attic)
#   Room7       bedroom2        (Red -> win scene,      Green -> basement,      Blue-> Living Room) red goes to winstate
#   Winning Scene
...
class IntroSceneLayer(cocos.layer.Layer):
    ...
    def on_exit(self):
            ...
            subprocess.call(["afplay", "audio/intro.mp3"])
...
class FloorPlanLayer(cocos.layer.Layer):
    ...
    def __init__(self):
        ...
        floorPlanTL.position = -10 , -305
        self.add(floorPlanTL, z = 2)
        
    def on_key_press(self, symbol, modifiers):
        if symbol == key.SPACE:
            print("space was pressed in floor plan")
            subprocess.call(["afplay", "audio/floorPlan.mp3"])
...
class LivingRoomLayer(cocos.layer.Layer):
    def __init__(self):
        ...
        textLabel = cocos.text.Label("Room 1 : Living Room",
              font_name= 'Times New Roman', font_size=72, anchor_x = "center", anchor_y = "center")
        textLabel.position = 50, 426
        self.add(textLabel)
        
        
class RedDoorLR(cocos.layer.Layer):  # transitions to basement. TELEPORTER
    is_event_handler = True
...
class GreenDoorLR(cocos.layer.Layer): # transitions to dining room 
    is_event_handler = True
...
class DiningRoomLayer(cocos.layer.Layer):
    def __init__(self):
        ...
        textLabel = cocos.text.Label("Room 2 : Dining Room",
              font_name= 'Times New Roman', font_size=72, anchor_x = "center", anchor_y = "center")
        textLabel.position = 50, 426
        self.add(textLabel)
...
class BedRoomLayer(cocos.layer.Layer):
    def __init__(self):
        ...
        textLabel = cocos.text.Label("Room 3 : Bedroom",
              font_name= 'Times New Roman', font_size=72, anchor_x = "center", anchor_y = "center")
        textLabel.position = 50, 426
        self.add(textLabel)


class RedDoorBR(cocos.layer.Layer): #transitions to the attic
    is_event_handler = True
    def __init__(self):
...
class BlueDoorBR(cocos.layer.Layer): #transitions to itself
    def __init__(self):
...
class AtticLayer(cocos.layer.Layer):
    def __init__(self):
        ...
        textLabel = cocos.text.Label("Room 4 : Attic",
              font_name= 'Times New Roman', font_size=72, anchor_x = "center", anchor_y = "center")
        textLabel.position = 50, 426
        self.add(textLabel)


class RedDoorAR(cocos.layer.Layer): #transitions to Basement
    is_event_handler = True
    def __init__(self):
...
class GreenDoorAR(cocos.layer.Layer): # transitions to bedroom scene
    is_event_handler = True
    def __init__(self):
...
class BlueDoorAR(cocos.layer.Layer): #transitions to itself
    def __init__(self):
...
class BasementLayer(cocos.layer.Layer):
    def __init__(self):
        ...
        textLabel = cocos.text.Label("Room 5 : Basement",
              font_name= 'Times New Roman', font_size=72, anchor_x = "center", anchor_y = "center")
        textLabel.position = 50, 426
        self.add(textLabel)


class RedDoorBA(cocos.layer.Layer): #transitions to BedRoom2. TELEPORTER
    is_event_handler = True
    def __init__(self):
    ...
    def on_mouse_press(self, x, y, buttons, modifiers):
        ...
        if(self.position_x >= 400 and self.position_x <= 490
            and self.position_y >= 40 and self.position_y <= 218):
           director.replace(BedRoom2Scene())



class GreenDoorBA(cocos.layer.Layer): # transitions to itself
    def __init__(self):
...
class BlueDoorBA(cocos.layer.Layer): #transitions to the hallway
    is_event_handler = True;
    def __init__(self):
...
class HallwayLayer(cocos.layer.Layer):
    def __init__(self):
        ...
        textLabel = cocos.text.Label("Room 6 : Hallway",
              font_name= 'Times New Roman', font_size=72, anchor_x = "center", anchor_y = "center")
        textLabel.position = 50, 426
        self.add(textLabel)
...
class GreenDoorHA(cocos.layer.Layer): # transitions to Bedroom2
    is_event_handler = True
    def __init__(self):
...
class BlueDoorHA(cocos.layer.Layer): #transitions to Attic
    is_event_handler = True;
    def __init__(self):
...
# Bedroom 2 scene
#
class BedRoom2Scene(cocos.scene.Scene):
    def __init__(self, *args, **kwargs):
        super(BedRoom2Scene, self).__init__()

        basement_layer = BedRoom2Layer()
...
class BedRoom2Layer(cocos.layer.Layer):
    def __init__(self):
        super(BedRoom2Layer, self).__init__()
        ...
        textLabel = cocos.text.Label("Room 7 : Bedroom2",
              font_name= 'Times New Roman', font_size=72, anchor_x = "center", anchor_y = "center")
        textLabel.position = 50, 426
        self.add(textLabel)


class RedDoorB(cocos.layer.Layer): #transitions to Winning Scene
    is_event_handler = True
    def __init__(self):
...
class GreenDoorB(cocos.layer.Layer): # transitions to basement 
    is_event_handler = True
    def __init__(self):
...
class BlueDoorB(cocos.layer.Layer): #transitions to living room
    is_event_handler = True;
    def __init__(self):
...
class WinningScene(cocos.scene.Scene):
    def __init__(self, *args, **kwargs):
        ...
        winning_layer = WinningLayer()
        self.add(winning_layer, z = 0)
...
class WinningLayer(cocos.layer.Layer):
    ...
    def __init__(self):
        ...
        textLabel = cocos.text.Label("CONGRATS! YOU HAVE ESCAPED. DONT COME BACK!!!!",
              font_name= 'Times New Roman', font_size=32, anchor_x = "center", anchor_y = "center")
        textLabel.position = 40, 100
        self.add(textLabel)
